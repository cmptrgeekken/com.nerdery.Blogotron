...
4. Add some gems to Gemfile to make our lives easier:
	
	gem 'inherited_resources'
	gem 'simple_form'

5. Update ~/app/controllers/articles_controller.rb to inherit from InheritedResources 
	
	class ArticlesController < InheritedResources::Base
		...
	end
6. Generate some basic views!
